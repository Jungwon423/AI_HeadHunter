...
const TravelContainer = () => {
  ...
  let operationHours = selectedPlace?.openingHours?.weekday_text
  const [workingStatus, setWorkingStatus] = useState(isOpenNow(operationHours))
  let statusText = workingStatus ? '영업 중' : '영업 종료'
  console.log(selectedPlace?.reviews?.length)
